...
const { uploadImageToSupabase, } = require("./service/storage");
...
router.get("/getPosts", async (req, res) => {
    try {
        ...
        const likeCounts = {};
        const isLikedMap = {}; // Fix conflict with variable name
        ...
        for (const post of posts) {
            ...
            // Fetch isLiked only if userid is provided
            if (userid) {
                ...
                isLikedMap[post.id] = !!likedData; // Convert to boolean
            }
        }
